// ── Markdown renderer + HTML sanitiser (zero-dependency) ─────────────���───────
// _renderMd   — converts Markdown to HTML
// _sanitizeHtml — strips scripts and inline event handlers
