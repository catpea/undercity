// library/submit/loopClip/af-loop-clip.js
//
// <af-loop-clip>
//
// Purpose-built submit component for the video-from-looping-clip-over-mp3 processor.
...
const JOB_TYPE = 'video-from-looping-clip-over-mp3';
...
class AfLoopClip extends HTMLElement {
...
customElements.define('af-loop-clip', AfLoopClip);
export { AfLoopClip };
