// library/input/month/af-ask-for-month.js
//
// <af-ask-for-month key="birth-month" label="Birth Month">
//
// Observed attributes:
...
//
// Input type: month. Binds on 'change' event.
...
template.innerHTML = `
  ...
  <input part="input" type="month">
  <div part="error" class="error"></div>
`;

class AfAskForMonth extends HTMLElement {
...
customElements.define('af-ask-for-month', AfAskForMonth);
export { AfAskForMonth };
