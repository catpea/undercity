// library/input/week/af-ask-for-week.js
//
// <af-ask-for-week key="sprint" label="Sprint Week">
//
// Observed attributes:
...
//
// Input type: week. Binds on 'change' event.
...
template.innerHTML = `
  ...
  <input part="input" type="week">
  <div part="error" class="error"></div>
`;

class AfAskForWeek extends HTMLElement {
...
customElements.define('af-ask-for-week', AfAskForWeek);
export { AfAskForWeek };
