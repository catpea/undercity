// library/input/date/af-ask-for-date.js
//
// <af-ask-for-date key="birthday" label="Date of Birth">
//
// Observed attributes:
...
class AfAskForDate extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.#scope.add(combined.subscribe(([key, label, min, max, required, help, size, validFeedback, invalidFeedback]) => {
      const fieldId = safeFieldId('af-date', key || 'field');
...
customElements.define('af-ask-for-date', AfAskForDate);
export { AfAskForDate };
